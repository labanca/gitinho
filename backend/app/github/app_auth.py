"""GitHub App authentication: JWT + installation token cache."""
...
class GitHubAppAuth:
    """Holds a cached installation token; rotates on expiry."""
    ...
    def _build_jwt(self) -> str:
        ...
        payload = {
            "iat": now - 60,
            "exp": now + 9 * 60,  # max 10 min per docs
            "iss": self._settings.GH_APP_ID,
        }
        return jwt.encode(
            payload,
