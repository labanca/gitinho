"""Issues — counts, last-by-user, free-form search."""

from __future__ import annotations

from typing import Any

from gitinho_mcp.github.graphql import ORG_OPEN_ISSUES
from gitinho_mcp.server import mcp
from gitinho_mcp.tools._context import get_context


@mcp.tool()
async def count_open_issues(repo: str | None = None) -> dict[str, Any]:
...
@mcp.tool()
async def last_issue_by_user(login: str) -> dict[str, Any]:
...
@mcp.tool()
async def search_issues(query: str, limit: int = 30) -> dict[str, Any]:
