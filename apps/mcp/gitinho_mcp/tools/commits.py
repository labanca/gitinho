...
from gitinho_mcp.github.graphql import REPO_LAST_COMMIT
from gitinho_mcp.server import mcp
from gitinho_mcp.tools._context import get_context


@mcp.tool()
async def last_commit_in_repo(repo: str) -> dict[str, Any]:
    """Most recent commit on the default branch of a repo (within the org)."""
